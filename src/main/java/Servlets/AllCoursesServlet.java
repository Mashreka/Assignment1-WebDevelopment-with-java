...
public class AllCoursesServlet extends HttpServlet {
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            out.println("<h2>Grit Academy Courses</h2><table>");
            ...
            while (resultSet.next()) {
                out.println("<tr><td>" + resultSet.getInt("id") + "</td><td>" + resultSet.getString("namn") + "</td><td>" + resultSet.getInt("YHP") + "</td><td>" + resultSet.getString("beskrivning") + "</td></tr>");
            }
